...
public class MongoImpl implements IMongoHelper {
	/** The mongo template. */
	 ...
	 */
	private void MongoDBHelper(MongoOperations mongoTemplate, MongoDbFactory dbFactory, MongoConverter converter) {
