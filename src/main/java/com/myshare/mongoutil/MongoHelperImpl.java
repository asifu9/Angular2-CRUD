 ...
 */
@Profile(value = "MONGO")
public class MongoHelperImpl implements IMongoHelper {
	/** The mongo template. */
	...
	/** The mongo db helper. */
	private static IMongoHelper mongoDBHelper;
	 ...
	 */
	MongoHelperImpl(MongoOperations mongoTemplate, MongoDbFactory dbFactory, MongoConverter converter) {
	 ...
	 */
	public static IMongoHelper getInstance(MongoOperations mongoTemplate, MongoDbFactory dbFactory, MongoConverter converter) {
		if (mongoDBHelper == null) {
			synchronized (MongoHelperImpl.class) {
				if (mongoDBHelper == null) {
					mongoDBHelper = new MongoHelperImpl(mongoTemplate, dbFactory, converter);
				}
			}
		}
	...
	public boolean enableShardingForCollection(String collectionName,
			Map<String, Boolean> shardKeyInfo, boolean isUnique) {
		// TODO Auto-generated method stub
		return false;
	}

	public boolean enableShardingForFileCollection(String collectionName) {
		// TODO Auto-generated method stub
		return false;
	}
